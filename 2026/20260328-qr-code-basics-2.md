...
[h] [Tập tin Excel mà tôi đã chuẩn bị](https://1drv.ms/x/c/060e62b48a00f0ba/IQAnMt3eHbYPQK7o4ypxRUL1AePcuX5oSIcrPFqC_xnDLN8?e=Whpvwy).     
[i] [Vị trí các hoa văn tọa độ theo từng kích cỡ QR](https://www.thonky.com/qr-code-tutorial/alignment-pattern-locations).     
[j] [Danh sách thông tin chữa lỗi tương ứng với hoa văn chữa lỗi và mức độ chữa lỗi đã chọn](https://www.thonky.com/qr-code-tutorial/format-version-tables).     
[k] [Một cách thức tính điểm phạt khác cho tiêu chí 4 của Thonky.com](https://www.thonky.com/qr-code-tutorial/data-masking#evaluation-condition-4).
...
[7] Thonky.com. (2025, March 28). *Error correction coding*. QR Code Tutorial. https://www.thonky.com/qr-code-tutorial/error-correction-coding     
[8] Kitz. (n.d.). ::. *Kitz - Interleaving* .:: https://kitz.co.uk/adsl/interleaving.htm
